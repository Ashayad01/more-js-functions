...
function addTheValues(param1, param2){
    if(isNaN(param1) || isNaN(param2)){
        addToPage("One of the perameters is not a number. When added they equal: " + param1 + " " + param2);
    }else{
...
function scopeExample(){
    let localVariable = "This is a local variable inside a scopeExample Function"
...
addToPage("The number varibale after doubling: " + number);
...
addToPage("The number variable after doubling asgain: " + number);
